...
echo "<br><br>";
  ...
  if (! $ret) {
    echo "<b>Graph error: </b>"."\n".rrd_error()."\n";
				...
				echo "<center><img src='server.png' height='650' width='1000' alt='Generated RRD image' ><center>";
				echo "<center><img src='device.png' height='6000' width='1000' alt='Generated RRD image' ></center>";
}
else
{
