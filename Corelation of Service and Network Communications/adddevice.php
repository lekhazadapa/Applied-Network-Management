...
<center> <h4> Fill in the device details to monitor </h4></center>
...
<center><input type="submit" value="Add device">
</form>
...
$tbl = "CREATE TABLE IF NOT EXISTS sassign2 ( 
...
$sqls = "INSERT INTO sassign2 (IP,PORT,COMMUNITY)
VALUES (\"$x\", \"$y\", \"$z\")";
...
//echo "Connected successfully<br>";
mysqli_select_db($conn,"$database");
    $sqlu = "UPDATE sassign2 SET interfaces='$joined' WHERE IP=\"$r\" AND PORT =\"$t\" AND COMMUNITY=\"$y\"";
