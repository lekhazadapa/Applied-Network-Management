...
$sql = "SELECT id,IP, PORT, COMMUNITY,interfaces FROM sassign2";
...
echo "<h2>servers</h2>";
$sql = "SELECT id,server FROM server2assignment";
$result = $conn->query($sql);
   $detailsarray = array("cpuload", "requestspersec", "transfbytespersec" , "bytesperrequest");
...
echo "<p style=\"text-indent: 5em\"><input type='checkbox' name='server_parameter[]'  value=cpuload> CPU Utilization<br></p>";
