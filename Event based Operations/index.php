...
<!-- Device input -->		
		<form method = "post">
		<table border=1 align="center"   bgcolor=white style="border-radius:10px;padding:10px" >
		<div><h2 style="font-family:verdana">Enter the details of the device</h2></div>
<div>
		<tr><td>IP<br></td>
		...
		<?php 	
			...
			$sql3 = "select * from `sassign3_trapdevice`";
...
#Entering values into the database		
		$sql = "CREATE TABLE IF NOT EXISTS `sassign3_trapdevice`(`id` int(11) NOT NULL,`ip` VARCHAR(100) NOT NULL,`port` VARCHAR(40) NOT NULL,`community` VARCHAR(100) NOT NULL,PRIMARY KEY( `id` ))";
...
{		#echo "Table created successfully\n";
		...
		$sql1 = "INSERT INTO `sassign3_trapdevice` ".
		       "(`ip`,`port`,`community`) ".
		       "VALUES ".
		       "('$ip','$port','$com')";
...
if($reset==1){
	$sql2 = "TRUNCATE `sassign3_trapdevice`";
...
$sql4="SELECT * FROM sassign3_traps";

$result2=$link->query($sql4);

echo '<table border=1 align="center"   bgcolor=white style="border-radius:10px;padding:10px" >
<tr>
<th>ID</th>
<th>Status</th>
<th>IP Address</th>
